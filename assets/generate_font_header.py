...
def generate_sdf_font_header():
    ...
    with open(header_path, 'w') as f:
        ...
        f.write("    };\n\n")
        f.write("    WGPUDepthStencilState depth_stencil = {\n")
        f.write("        .format              = WGPUTextureFormat_Depth24Plus,\n")
        f.write("        .depthWriteEnabled   = WGPUOptionalBool_False,\n")
        f.write("        .depthCompare        = WGPUCompareFunction_Always,\n")
        f.write("        .stencilFront        = {\n")
        f.write("            .compare         = WGPUCompareFunction_Always,\n")
        f.write("            .failOp          = WGPUStencilOperation_Keep,\n")
        f.write("            .depthFailOp     = WGPUStencilOperation_Keep,\n")
        f.write("            .passOp          = WGPUStencilOperation_Keep,\n")
        f.write("        },\n")
        f.write("        .stencilBack         = {\n")
        f.write("            .compare         = WGPUCompareFunction_Always,\n")
        f.write("            .failOp          = WGPUStencilOperation_Keep,\n")
        ...
        f.write("            .passOp          = WGPUStencilOperation_Keep,\n")
        f.write("        },\n")
        f.write("        .stencilReadMask     = 0xFFFFFFFF,\n")
        f.write("        .stencilWriteMask    = 0xFFFFFFFF,\n")
        f.write("        .depthBias           = 0,\n")
        f.write("        .depthBiasSlopeScale = 0.0f,\n")
        f.write("        .depthBiasClamp      = 0.0f,\n")
        f.write("    };\n\n")
        ...
        f.write("        },\n")
        f.write("        .depthStencil = &depth_stencil,\n")
        f.write("        .multisample = {\n")
        f.write("            .count                  = 1,\n")
